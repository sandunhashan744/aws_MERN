...
const footer = () => {
  return (
    <>
    <footer className="py-7 px-6 md:px-16 bg-gray-900 w-full border-t-2  border-slate-400">
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">TradeCopier™</a>. All Rights Reserved.
            </span>
